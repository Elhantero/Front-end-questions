...
const SingleQuestionWitnAnswer = ({ questionId, question } : { questionId: number, question: questionsTypes.SingleQuestion }) => {
...
export default connect(mapStateToProps)(SingleQuestionWitnAnswer);
